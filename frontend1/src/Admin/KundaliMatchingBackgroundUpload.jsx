...
const KundaliMatchingBackgroundUpload = () => {
  ...
  useEffect(() => {
    // Fetch current background image on component mount
    fetchCurrentImage();
  }, []);
  ...
  const fetchCurrentImage = async () => {
    try {
      ...
      console.log('No current background image found or error fetching image');
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await adminAPI.uploadKundaliMatchingBackground(formData);
      ...
      <div className="relative z-10 py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-3xl font-cinzel font-bold text-white mb-2">
                Kundali Matching Background Upload
              </h1>
              <p className="text-gray-300">Upload background image for the Kundali Matching page</p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="glass-card rounded-xl p-6 border border-astro-gold/20">
              <h2 className="text-xl font-bold text-white mb-4">Current Background Image</h2>
              ...
              {currentImage ? (
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-gray-300 mt-4 text-center">
                    This is the current background image displayed on the Kundali Matching page
                  </p>
                </div>
              ) : (
                <div className="flex flex-col items-center justify-center h-64 bg-white/5 rounded-lg border border-white/10">
                  ...
                  <p className="text-gray-400 text-center">
                    No background image has been uploaded yet. Upload an image to display it on the Kundali Matching page.
                  </p>
                </div>
              )}
            </div>
...
export default KundaliMatchingBackgroundUpload;